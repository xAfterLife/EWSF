...
public:
	...
	{
		return static_cast<size_t>(current_ - buffer_);
	}
};
...
public:
	...
	JsonWriter(char* dest, size_t maxLen) : JsonWriterBase(stringBuffer_, &stackAlloc_, WriterNestingLevels),
...
public:
	...
	JsonDocument() : JsonDocumentBase(rapidjson::kObjectType, &poolAllocator_, sizeof stackAllocator_.fixedBuffer_,
	                                  &stackAllocator_),
